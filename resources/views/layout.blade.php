	...
	<div class="wrapper">
		...
		<div class="sidebar-wrapper" data-simplebar="true">
			<div class="sidebar-header">
				<div>
					<img src="{{ asset('assets/images/logo-img.png') }}" style="width: 110px;" class="logo-icon" alt="logo icon">
				</div>
			...
			<ul class="metismenu" id="menu">
				...
				<li>
					...
					<ul>
						...
						<li> <a href="/persetujuan-admin"><i class="bx bx-right-arrow-alt"></i>Persetujuan Admin</a>
						</li>
						<li> <a href="/pengambilan-barang"><i class="bx bx-right-arrow-alt"></i>Pengambilan Barang</a>
						</li>
						@endif
						@if(Auth::user()->role == 'Wadir')
						<li> <a href="/persetujuan-wadir"><i class="bx bx-right-arrow-alt"></i>Persetujuan Wadir</a>
						</li>
						@endif
					</ul>
				</li>
				...
				<li>
					<a href="/serah-terima">
						...
						<div class="menu-title">Data Serah-Terima</div>
					</a>
				</li>
				@endif
				<li>
				...
				<nav class="navbar navbar-expand">
					...
					<div class="user-box dropdown">
						<a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
							<img src="{{ asset('assets/images/default-user.jpg') }}" class="user-img" alt="user avatar">
